...
function preload(){
  bg=loadImage("bg.png")
  mario_running =   loadAnimation("w1.png","w2.png","w3.png","w4.png","w5.png","w8.png")
  mario_collided = loadAnimation("f8.png","f8.png")
  
  groundImage = loadImage("iceground1.png");
  
  brickImage = loadImage("ice.png");
  
  obstacleimage = loadImage("snowtree.png");
...
function setup() {
  ...
  ground1 = createSprite(windowWidth*3/2,windowHeight-20,windowWidth,20);
  ground1.addImage("ground",groundImage);
  //ground.x = windowWidth/2;
  ground1.velocityX = -(2);

  mario = createSprite(150,windowHeight-50,20,50),
